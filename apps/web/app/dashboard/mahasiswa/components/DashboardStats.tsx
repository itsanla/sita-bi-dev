...
import { BookOpen, MessagesSquare, Calendar, Award, TrendingUp } from 'lucide-react';
  ...
  const statsCards = [
    ...
    },
    {
      ...
      subtitle: stats.sidang.tanggal
        ? new Date(stats.sidang.tanggal).toLocaleDateString('id-ID', { day: 'numeric', month: 'long' })
        : 'Belum dijadwalkan',
      icon: Calendar,
