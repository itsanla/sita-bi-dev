...
// VERSI FINAL: Menggabungkan semua perubahan dari 9 branch
...
// Dari code1-pelaporan-aktifitas
enum LogLevel {
  INFO
  WARN
  ERROR
...
model User {
  ...
  pengumumanDibaca   PengumumanPembaca[] // Dari code1-pengumuman
  ...
  notificationHistory NotificationHistory[]   // Dari code1-notifikasi
  emailTokens        EmailVerificationToken[]
  passwordResetTokens PasswordResetToken[]    // Dari code1-auth
  catatanBimbingan   CatatanBimbingan[]
  lampiranBimbingan  LampiranBimbingan[]     // Dari code1-bimbingan
  files              File[]                   // Dari code1-management-file
  historyPenugasan   HistoryPenugasanDosen[] @relation("AdminAssigner") // Dari code1-penugasan-dosen
  historyPerubahanSidang HistoryPerubahanSidang[] // Dari code1-management-sidang
...
model Dosen {
  ...
  PengajuanBimbingan PengajuanBimbingan[]
  historyPenugasanDosen HistoryPenugasanDosen[] // Dari code1-penugasan-dosen
...
model BimbinganTA {
  ...
  lampiran         LampiranBimbingan[]      // Dari code1-bimbingan
...
// Dari code1-bimbingan
model LampiranBimbingan {
  id              Int      @id @default(autoincrement())
  bimbingan_ta_id Int
  file_path       String
...
model Sidang {
  ...
  nilaiSidang       NilaiSidang[]
  historyPerubahan  HistoryPerubahanSidang[] // Dari code1-management-sidang
...
model Pengumuman {
  ...
  // Dari code1-pengumuman: Fitur Lanjutan
  is_published   Boolean           @default(false)
  scheduled_at   DateTime?
  prioritas      PrioritasPengumuman @default(MENENGAH)
  kategori       KategoriPengumuman  @default(LAINNYA)
  ...
  lampiran  PengumumanLampiran[] // Dari code1-pengumuman
  pembaca   PengumumanPembaca[]  // Dari code1-pengumuman
